...
import RoundIcon from './roundicon2.png'
import RoundIcontw from './roundicon.png'
import UserIcon from './userIcon.png'
import UserIcontw from './userIcontw.png'
import EuroIcontw from './Erotw.png'
import Euroicon from './EuroIcon.png'
      ...
      <div className="container-fluid">
        <div className="row mb-2">
          <div className="col-sm-6">
            <h1 className="m-0">Default Dashboard</h1>
            <span className="welcmText">Welcome MAGEMAX React Admin Dashboard.</span>
          </div>{/* /.col */}
        </div>{/* /.row */}
      </div>{/* /.container-fluid */}
    </div>
      ...
      <div className="container-fluid">
        ...
        <div className="row">
          <div className="col-lg-4 col-6">
            ...
            <div className="row">
              <div className="innbox inner col-lg-3">
                <img src={RoundIcontw} /></div>
              <div className="inner col-lg-7">
                 <h3>29381</h3>
          ...
          <div className="col-lg-4 col-6">
            ...
            <div className="row">
              <div className="innbox inner col-lg-3">
                <img src={UserIcon} /></div>
              <div className="inner col-lg-7">
                 <h3>2398</h3>
                <p>Total Users Registred</p>
              </div>
              <div className="icon">
                {/* <i className="ion ion-bag" /> */}
                <img src={UserIcontw} />
            ...
            <div className="card">
              ...
              <div className="card-body">
                <div className="tab-content p-0">
                  {/* Morris chart - Sales */}
                  <div id="donutchart" style={{width: 800, height: 400}} />
              ...
              <div className="card-body">
                ...
                <div className="direct-chat-messages">
                  ...
                  <div className="direct-chat-msg">
                    ...
                    {/* /.direct-chat-infos */}
                    <image className="direct-chat-img" src="dist/img/user1-128x128.jpg" alt="message user image" />
                    {/* /.direct-chat-img */}
                  ...
                  <div className="direct-chat-msg right">
                    ...
                    {/* /.direct-chat-infos */}
                    <image className="direct-chat-img" src="dist/img/user3-128x128.jpg" alt="message user image" />
                    {/* /.direct-chat-img */}
                    <div className="direct-chat-text">
        ...
        <div className="col-md-8">
          <div className="card">
            ...
            <div className="card-body" style={{height: 420}}>
              ...
              <div className=" ct-chart ct-square chartjs-render-monitor" style={{display: 'block', width: 550, height: 400}} />
            </div>
          </div>
        </div>
      </div>
